...
async function searchMovies(data) {
    let promise = new Promise((resolve, reject) => {
        tmdb.search.movie(data, 1, (err, res) => {
            resolve(res.results.map(function(tmdb){
                return(
                    {
                      //  tmdb: tmdb,
                        id: tmdb.id,
                        ...
                        imageUrlV2: 'https://image.tmdb.org/t/p/w92' + tmdb.poster_path,
                        imageUrlV3: 'https://image.tmdb.org/t/p/w780' + tmdb.poster_path
